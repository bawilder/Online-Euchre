...
public class EuchreGame {
	...
	public void runTrick(){
		...
		System.out.println("Player 1, play a card from this hand: (1-5 are the viable inputs)");
		...
		System.out.println("Player 2, play a card from this hand: (1-5 are the viable inputs)");
		...
		System.out.println("Player 3, play a card from this hand: (1-5 are the viable inputs)");
		...
		System.out.println("Player 4, play a card from this hand: (1-5 are the viable inputs)");
		...
		Card maxCard= new Card('A',0,'A');
		int playerOfCard=0;
		for(int i=0; i<3; i+=1){
			
			//if statement until card evaluation is more accurate
			if(maxCard.value <= table.tableCards[i].value){
				maxCard=table.tableCards[i];
				playerOfCard=i;
			}
			
			//this will be the actual if after evaluation is cleaned up
			//if(maxCard.value < table.tableCards[i].value){
			//	maxCard=table.tableCards[i];
			//	playerOfCard=i;
			//}
	...
	public void runHand(){
		...
		if(table.team1.getTricks()>2){
			...
			System.out.println("Player 1 earned " + table.players[0].tricks + " trick(s), and Player 3 earned " + table.players[2].tricks + " trick(s).");
			...
			table.players[1].clearTricks();
			table.players[3].clearTricks();
			System.out.println();
		}
